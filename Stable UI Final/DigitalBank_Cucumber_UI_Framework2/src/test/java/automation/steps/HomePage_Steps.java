...
//    @When("user clicks on {string} dropdown")
//    public void userClicksOnDropdown(String args) {
//        homePage.userClicksOnDropDownBtn(args);
//    }


    @Then("verify {string} are available")
    public void verifyAreAvailable(String args) {
        homePage.verifySavingsCategory(args);
    }

    @And("user select {string} option")
    public void userSelectOption(String arg0) {
        homePage.userSelectNewSavings(arg0);
    }


    @Then("and verify {string} are displayed")
    public void andVerifyAreDisplayed(String arg0) {
        homePage.verifySavingsAccCategory(arg0);
    }
}
